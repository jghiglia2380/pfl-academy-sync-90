...
import RiskToleranceAssessmentForm from "./RiskToleranceAssessmentForm";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function RiskToleranceAssessment({ skillBuilder, onComplete }) {
