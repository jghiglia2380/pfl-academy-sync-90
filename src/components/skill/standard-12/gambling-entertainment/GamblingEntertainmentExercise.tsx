...
import GamblingEntertainment from "./GamblingEntertainment";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function GamblingEntertainmentExercise({ skillBuilder, onComplete }) {
