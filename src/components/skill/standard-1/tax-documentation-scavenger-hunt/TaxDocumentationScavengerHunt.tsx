...
import TaxDocumentationScavengerHuntForm from "./TaxDocumentationScavengerHuntForm";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function TaxDocumentationScavengerHunt({ skillBuilder, onComplete }) {
  ...
  const [formData, setFormData] = useState<any>({
    w2: { screenshot: "", description: "", importance: "" },
    form1099: { screenshot: "", description: "", importance: "" },
    form1040: { screenshot: "", description: "", importance: "" },
    reflection: "",
    aiResponse: "",
  });
  ...
  return (
    <div className="max-w-[1000px] mx-auto py-8">
      ...
      <div className="mb-8">
        <TaxDocumentationScavengerHuntForm
          formData={formData}
