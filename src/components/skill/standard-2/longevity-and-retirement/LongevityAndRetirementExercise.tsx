...
import LongevityAndRetirement from "./LongevityAndRetirement";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function LongevityAndRetirementExercise({ skillBuilder, onComplete }) {
  ...
  const [formData, setFormData] = useState({
    lifeExpectancy: "",
    currentAge: "",
    retirementAge: "65", // Added retirement age with default
    annualExpenses: "",
    inflationRate: "",
    returnRate: "",
    reflection: "",
