...
import FinancialInstitutionsServicesForm from "./FinancialInstitutionsServicesForm";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function FinancialInstitutionsServices({ skillBuilder, onComplete }) {
  ...
  return (
    <div className="max-w-[1000px] mx-auto py-8">
      ...
      <div className="mb-8">
        {currentStep === 0 && (
          <FinancialInstitutionsServicesForm
