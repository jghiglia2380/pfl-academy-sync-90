...
import TheftProtectionChecklist from "./TheftProtectionChecklist";
import {
  saveSkillBuilder,
  getSkillBuilder,
...
export function TheftProtectionExercise({ skillBuilder, onComplete }) {
  ...
  return (
    <div className="max-w-[1000px] mx-auto py-8">
      ...
      <div className="mb-8">
        {currentStep === 0 && (
          <TheftProtectionChecklist
            onExerciseCompleted={handleExerciseComplete}
            formData={formData}
